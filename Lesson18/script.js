...
let streetAddress = homeAddress.line1;

// Don't use arrays like this!!
const addressAsArray = ['Kungstagan 1', 'Gothenburg', '422 55'];

streetAddress = addressAsArray[0];

const addressBook = [homeAddress, workAddress];

const addressBookArrayObject = {
	0: homeAddress,
	1: workAddress,
};

// Objects - used for grouping data when keys are important
// Arrays - use as collections of similar items, especially when an iteration is needed
